...
export const ResetPasswordEmail = ({ code, expires }: Props) => (
  <Html>
    <Head />
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Text style={heroText}>
          Your confirmation code is below - enter it in your open browser window and we'll help you reset your password.
        </Text>
