  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn("group/sidebar-wrapper flex w-full bg-sidebar", className)}
        {...props}
      >
        {children}
      </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col p-0 transition-all md:p-4 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:pl-4 md:pl-0",
        className,
      )}
      {...props}
    />
