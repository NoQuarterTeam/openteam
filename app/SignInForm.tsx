...
export function SignInForm() {
  ...
  return (
    <div className="w-full">
        ...
        onSubmit={(e) => {
          ...
          void signIn("password", formData).catch((error) => {
            ...
            if (error.message.includes("Invalid password")) {
              ...
              toastTitle =
                flow === "signIn" ? "Could not sign in, did you mean to sign up?" : "Could not sign up, did you mean to sign in?"
            }
      ...
      <button className="auth-button" type="button" onClick={() => void signIn("anonymous")}>
        Sign in anonymously
      </button>
    </div>
  )
